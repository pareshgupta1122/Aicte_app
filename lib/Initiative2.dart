...
import 'package:aicte_app/schemes.dart';
...
class Initiative2 extends StatefulWidget {
  const Initiative2({Key? key}) : super(key: key);

  @override
  State<Initiative2> createState() => _Initiative2State();
}

class _Initiative2State extends State<Initiative2> {
  @override
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Jai Shakti Abhiyan",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("One Student One Time",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Student Learning Assesent(PARAKH)",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Education Alliance For Technology(NEAT)",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("AICTE internship Portal",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              Padding(
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: (){
                      Navigator.push(context,MaterialPageRoute(builder:(context)=>Schemes()));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
