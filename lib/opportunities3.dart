...
import 'package:aicte_app/opportunities4.dart';
...
class Opportunities3 extends StatefulWidget {
  const Opportunities3({Key? key}) : super(key: key);

  @override
  State<Opportunities3> createState() => _Opportunities3State();
}

class _Opportunities3State extends State<Opportunities3> {
  @override
            ...
            children: [
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Closed Institutes",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Institutes with Autonomy",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("BULLETINS",style: GoogleFonts.inter(color:Colors.black,fontWeight: FontWeight.bold )),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Advertisement",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Tenders",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Circulars",style: GoogleFonts.inter(color:Colors.black )),
                  ],
                ),
              ),
              Padding(
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: (){
                      Navigator.push(context,MaterialPageRoute(builder:(context)=>Opportunities4()));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
